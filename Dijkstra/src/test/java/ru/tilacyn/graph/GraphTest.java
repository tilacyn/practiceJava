...
public class GraphTest {
    ...
    public static class Sources {
        ...
        static {
            g1.add(new ArrayList<>(Arrays.asList(1, 2))); // 0
            g1.add(new ArrayList<>(Collections.singletonList(0))); // 1
            g1.add(new ArrayList<>(Arrays.asList(0, 3))); // 2
            g1.add(new ArrayList<>(Collections.singletonList(2))); // 3

            put(0, 1, 1, e1);
            put(0, 2, 2, e1);
            put(2, 3, 2, e1);

            g2.add(new ArrayList<>(Arrays.asList(1, 2, 3))); // 0
            g2.add(new ArrayList<>(Arrays.asList(0, 2))); // 1
            g2.add(new ArrayList<>(Arrays.asList(0, 1, 3))); // 2
            g2.add(new ArrayList<>(Arrays.asList(2, 0, 4))); // 3
            g2.add(new ArrayList<>(Collections.singletonList(3))); // 3
            ...
            g3.add(new ArrayList<>(Arrays.asList(1, 2))); // 0
            g3.add(new ArrayList<>(Arrays.asList(0, 3, 4))); // 1
            g3.add(new ArrayList<>(Arrays.asList(0, 4, 7))); // 2
            g3.add(new ArrayList<>(Arrays.asList(1, 5))); // 3
            g3.add(new ArrayList<>(Arrays.asList(1, 5, 6, 2))); // 4
            g3.add(new ArrayList<>(Arrays.asList(4, 3))); // 5
            g3.add(new ArrayList<>(Arrays.asList(4, 7))); // 6
            g3.add(new ArrayList<>(Arrays.asList(6, 2))); // 7
    ...
    public void getNeighbours() throws Exception {
        assertEquals(graph1.getNeighbours(0), new ArrayList<>(Arrays.asList(1, 2)));
        assertEquals(graph1.getNeighbours(1), new ArrayList<>(Collections.singletonList(0)));
        assertEquals(graph1.getNeighbours(2), new ArrayList<>(Arrays.asList(0, 3)));
        assertEquals(graph1.getNeighbours(3), new ArrayList<>(Collections.singletonList(2)));
    }
